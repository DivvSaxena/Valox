...
export const GlareCard = ({
  ...
  const containerStyle = {
    ...
    "--radius": "12px", // Reduced radius for a sharper corner
    "--easing": "ease",
  ...
  const backgroundStyle = {
    ...
    "--shade":
      "radial-gradient( farthest-corner circle at var(--m-x) var(--m-y),rgba(255,255,255,0.2) 12%,rgba(255,255,255,0.3) 20%,rgba(255,255,255,0) 90% ) var(--bg-x) var(--bg-y)/300% no-repeat",
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[400px] h-[200px]" // Increased width and decreased height
      ref={refElement}
      onPointerMove={(event) => {
